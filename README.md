...
| `brand-design-md` | 从 getdesign.md 获取 62 个顶级品牌的 DESIGN.md 规范，生成匹配品牌风格的 UI | HTML / React / Vue / CSS |
...
- 外部规范来源：`brand-design-md` 会运行 `npx getdesign@latest` 获取公开品牌设计规范，需联网和 Node.js 环境；生成结果商用前仍要检查品牌授权边界。
