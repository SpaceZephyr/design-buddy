...
Structure for user preferences in `.space-skills/space-slide-deck/EXTEND.md`.
...
Then use with: `/space-slide-deck content.md --style style-name`
...
1. `.space-skills/space-slide-deck/EXTEND.md` (project)
2. `$HOME/.space-skills/space-slide-deck/EXTEND.md` (user)
