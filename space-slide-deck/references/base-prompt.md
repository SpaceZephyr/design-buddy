...
Please use GPT-image-2 (LabNana API) to generate the slide image based on the content provided above.

---
## API Configuration

- Provider: LabNana (https://api.labnana.com)
- Model: gpt-image-2
- Aspect Ratio: 16:9
- Resolution: 2K
- API Key: Configured in .labnana.env

Call using:
```bash
python3 /Users/ugreen/.claude/skills/space-slide-deck/scripts/generate_slide.py \
