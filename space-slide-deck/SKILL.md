...
/space-slide-deck path/to/content.md --outline-only
/space-slide-deck  # Then paste content
```
...
test -f .space-skills/space-slide-deck/EXTEND.md && echo "project"

# Then user-level (cross-platform: $HOME works on macOS/Linux/WSL)
test -f "$HOME/.space-skills/space-slide-deck/EXTEND.md" && echo "user"
```

┌──────────────────────────────────────────────────┬───────────────────┐
│                       Path                       │     Location      │
├──────────────────────────────────────────────────┼───────────────────┤
│ .space-skills/space-slide-deck/EXTEND.md         │ Project directory │
├──────────────────────────────────────────────────┼───────────────────┤
│ $HOME/.space-skills/space-slide-deck/EXTEND.md   │ User home         │
└──────────────────────────────────────────────────┴───────────────────┘
...
```bash
/space-slide-deck content.md --prompts-only
```
...
```bash
/space-slide-deck slide-deck/topic-slug/ --images-only
```
...
```bash
# Single slide
/space-slide-deck slide-deck/topic-slug/ --regenerate 3

# Multiple slides
/space-slide-deck slide-deck/topic-slug/ --regenerate 2,5,8
```
...
2. Run: `/space-slide-deck <dir> --regenerate N`
