...
![Last Update](https://img.shields.io/github/last-commit/SpaceZephyr/design-buddy?style=flat-square&label=last%20update)
![License](https://img.shields.io/github/license/SpaceZephyr/design-buddy?style=flat-square)
...
mkdir -p ~/.claude/skills/space-brand-ui-design
cp design-buddy/space-brand-ui-design/SKILL.md ~/.claude/skills/space-brand-ui-design/SKILL.md
```
